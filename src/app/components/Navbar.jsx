...
const productLinks = [
  {
    name: "Corded Vacuums",
    img: "/category-image/Corded Vacuums.webp",
    slug: "corded vacuums",
  },
  {
    name: "Cordless Vacuums",
    img: "/category-image/Cordless-Vacuums.webp",
    slug: "cordless-vacuums",
  },
  { name: "Robots", img: "/category-image/robots.webp", slug: "robots" },
  {
    name: "Carpet Washers",
    img: "/category-image/Carpet Washers.webp",
    slug: "carpet-washers",
  },
  {
    name: "Hard Floor Cleaners",
    img: "/category-image/Hard Floor Cleaners.webp",
    slug: "hard-floor-cleaners",
  },
  { name: "Steamers", img: "/category-image/steamers.webp", slug: "steamers" },

  {
    name: "Commercial",
    img: "/category-image/commercial.webp",
    slug: "commercial",
  },
  {
    name: "Cleaning Chemicals",
    img: "/category-image/Cleaning-Chemicals.webp",
    slug: "cleaning-chemicals",
  },
  {
    name: "Accessories & Parts",
    img: "/category-image/Accessories.webp",
    slug: "accessories & parts",
  },
  {
    name: "Vacuum Bags & Filters",
    img: "/category-image/Vacuum-Bags.webp",
    slug: "vacuum-bags & filters",
  },
];
          ...
          <div className="md:hidden bg-white px-4 py-2 space-y-3 text-[15px] text-black">
            ...
            <div>
              ...
              <ul className="ml-4 mt-1 space-y-1">
                {storeLinks.map((city) => (
                  <li key={city}>
                    <Link href={`/our-stores/${city.toLowerCase()}-store`}>
                      {city}
                    </Link>
                  </li>
                ))}
