            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 py-10 sm:py-14 md:py-16 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center">
                ...
                <div>
                    ...
                    <p className="text-gray-700 text-base sm:text-lg leading-relaxed mb-8 text-center md:text-left">
                        Get your Hoover vacuum performing like new with our expert repair and maintenance services in Sunbury. Whether you’re dealing with reduced suction, motor issues, or worn-out components, we service all Hoover models with care and precision. Our skilled technicians provide quick diagnostics, use genuine Hoover parts, and deliver reliable repairs—so your vacuum stays powerful and your home stays spotless, without the hassle.
