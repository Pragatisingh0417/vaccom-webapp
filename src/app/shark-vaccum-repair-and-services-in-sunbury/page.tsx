            ...
            >
                <div className="text-white max-w-4xl space-y-4 mx-auto md:mx-0">
                    <h1 className="text-2xl sm:text-3xl md:text-5xl font-bold text-center md:text-left px-4 sm:px-6 md:px-10">
                        Shark Vacuum Repair and Services in Sunbury
                    </h1>
                </div>
            </section>
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 py-10 sm:py-14 md:py-16 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center">
                ...
                <div>
                    <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-red-600 mb-4 leading-snug text-center md:text-left">
                        Shark Vacuum Repair and   <br />Services in Sunbury
                    </h2>

                    <p className="text-gray-700 text-base sm:text-lg leading-relaxed mb-8 text-center md:text-left">
                        Get your Shark vacuum running like new with our expert repair and maintenance services in Sunbury. Whether it’s loss of suction, motor problems, or general wear and tear, we service all Shark models with care and precision. Our skilled local technicians provide fast diagnostics, genuine parts, and dependable repairs—keeping your vacuum powerful and your home spotless without the stress.
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 py-10 sm:py-14 md:py-16 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center">
                ...
                <div className="text-center md:text-left">
                    <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-black mb-4 leading-snug">
                        Shark Vacuum Repair & Service
                    </h2>
                    <p className="text-gray-700 text-base sm:text-lg leading-relaxed mb-8">


                        You may be surprised that our thorough vacuum service is very affordable.

                        If your vacuum is overheating, won’t start, has a strange odor, or isn’t picking up dirt the way it should, it’s time to let the experts take a look. Bring it in for a free estimate—no obligation. Our certified technicians have the skills and experience to repair all makes and models. Stop by one of our locations or request your free estimate today!     </p>
